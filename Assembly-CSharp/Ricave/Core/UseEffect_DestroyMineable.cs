...
{
    public class UseEffect_DestroyMineable : UseEffect
    {
        protected UseEffect_DestroyMineable()
        {
        }

        public UseEffect_DestroyMineable(UseEffectSpec spec)
        ...
        public override IEnumerable<Instruction> MakeUseInstructions(Actor user, IUsable usable, Target target, Target originalTarget, BodyPart targetBodyPart)
        {
            ...
            if (structure == null || !structure.Spec.Structure.IsMineable || !structure.Spawned)
            {
                yield break;
            }
