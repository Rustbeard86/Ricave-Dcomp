...
{
    public class UseEffect_DestroyDiggable : UseEffect
    {
        protected UseEffect_DestroyDiggable()
        {
        }

        public UseEffect_DestroyDiggable(UseEffectSpec spec)
        ...
        public override IEnumerable<Instruction> MakeUseInstructions(Actor user, IUsable usable, Target target, Target originalTarget, BodyPart targetBodyPart)
        {
            ...
            if (structure == null || !structure.Spec.Structure.IsDiggable || !structure.Spawned)
            {
                yield break;
            }
